...
# Begin Custom Build - Copying to \SIERRA\Half-Life\ice\cl_dlls
TargetDir=.\Debug
InputPath=.\Debug\client.dll
SOURCE="$(InputPath)"

"\SIERRA\Half-Life\ice\cl_dllsclient.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\client.dll \SIERRA\Half-Life\ice\cl_dlls
